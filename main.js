...
function display_input() {
  ...
  if ((document.getElementById("texto").value.match(any_number)) || (document.getElementById("texto").value == '')) {
    ...
    document.getElementById("caja_amarillo_inner_text").innerText =
...
document.getElementById("colores").addEventListener("change", background_color);

function background_color() {
  document.getElementById(
    "right"
  ).style.backgroundColor = document.getElementById("colores").value;
}
